...
#> <bytecode: 0x55cc285592d0>
#> <environment: 0x55cc285589a0>
f(x)
...
#>     i
#>   }
#> <bytecode: 0x55cc279f5078>
#> <environment: 0x55cc27553aa8>
```
...
#> 1 LL1          25.7µs   29.1µs    33733.    12.9KB     13.5
#> 2 LL2          13.4µs   15.1µs    64425.        0B     12.9
```
...
#>  1     10 LL1            37µs   41.3µs    24153.
#>  2     10 LL2          16.1µs   18.1µs    55087.
#>  3     20 LL1          39.4µs   43.8µs    22948.
#>  4     20 LL2            17µs   17.6µs    56045.
#>  5     50 LL1            43µs   47.8µs    20650.
#>  6     50 LL2            15µs   16.6µs    60576.
#>  7    100 LL1          57.2µs   63.3µs    15745.
#>  8    100 LL2          16.1µs     18µs    55398.
#>  9   1000 LL1         789.6µs  890.9µs     1119.
#> 10   1000 LL2            50µs     55µs    18402.
