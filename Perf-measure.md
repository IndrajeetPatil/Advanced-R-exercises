...
#> 1 f()           102µs    157µs     6244.    4.65MB     88.7
```
...
#> 1 sqrt(x)         1.02µs   1.37µs   589656.    7.86KB
#> 2 exp(log(x)/2)   6.15µs   7.13µs   142785.    7.86KB
#> 3 x^0.5           9.27µs   9.47µs   102542.    7.86KB
#> 4 x^(1/2)         9.27µs  10.04µs    98814.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
