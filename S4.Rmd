...
```{r, echo=FALSE}
knitr::include_graphics("https://advanced-r-solutions.rbind.io/images/s4/method_dispatch1.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://advanced-r-solutions.rbind.io/images/s4/method_dispatch2.png")
```
