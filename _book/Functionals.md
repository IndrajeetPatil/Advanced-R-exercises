...
#> <environment: 0x00000000204e2fa0>
...
#> <environment: 0x00000000323c0ae8>
...
#> <environment: 0x0000000032501488>
...
#> <environment: 0x00000000325d5e48>
...
#> <environment: 0x0000000033318980>
```
...
e <- env("x" = 1, "y" = 2)
rlang::env_print(e)
#> <environment: 0x0000000032e32ec0>
