...
#> <environment: 0x00000000204de360>
...
#> <environment: 0x00000000323abff8>
...
#> <environment: 0x00000000324ec998>
...
#> <environment: 0x00000000325c1358>
...
#> <environment: 0x0000000033308c50>
```
...
e <- env("x" = 1, "y" = 2)
rlang::env_print(e)
#> <environment: 0x0000000032e225c0>
