...
#> 1 f()           104µs    161µs     5797.    4.65MB     82.3
```
...
#> 1 sqrt(x)         1.02µs   1.44µs   524301.    7.86KB
#> 2 exp(log(x)/2)   6.19µs   7.17µs   141432.    7.86KB
#> 3 x^0.5           9.27µs  10.17µs    99815.    7.86KB
#> 4 x^(1/2)         9.31µs  10.25µs    99322.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
