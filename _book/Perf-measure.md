...
#> 1 f()           100µs    142µs     6872.    4.65MB     97.6
```
...
#> 1 sqrt(x)         1.07µs   1.39µs   642908.    7.86KB
#> 2 exp(log(x)/2)   6.19µs    7.3µs   140060.    7.86KB
#> 3 x^0.5           9.31µs   9.55µs   100212.    7.86KB
#> 4 x^(1/2)         9.31µs   9.76µs    98912.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1     644.
#> 2       0 
