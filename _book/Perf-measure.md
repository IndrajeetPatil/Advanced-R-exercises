...
#> 1 f()           101µs    154µs     6148.    4.65MB     87.3
```
...
#> 1 sqrt(x)         1.07µs   1.31µs   701853.    7.86KB
#> 2 exp(log(x)/2)    6.4µs   7.38µs   138168.    7.86KB
#> 3 x^0.5           9.27µs   9.55µs    99778.    7.86KB
#> 4 x^(1/2)         9.27µs  10.25µs    99224.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1     703.
#> 2       0 
