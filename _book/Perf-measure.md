...
#> 1 f()           134µs    192µs     4727.     792KB     72.0
```
...
#> 1 sqrt(x)         1.48µs   2.99µs   290531.    7.86KB
#> 2 exp(log(x)/2)    8.9µs  13.08µs    71303.    7.86KB
#> 3 x^0.5          13.16µs  17.43µs    54275.    7.86KB
#> 4 x^(1/2)        13.28µs  18.33µs    52600.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
