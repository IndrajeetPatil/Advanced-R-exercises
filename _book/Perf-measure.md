...
#> 1 f()          99.5µs    134µs     7134.     792KB     109.
```
...
#> 1 sqrt(x)         1.07µs   1.68µs   554750.    7.86KB
#> 2 exp(log(x)/2)   6.11µs   7.22µs   140820.    7.86KB
#> 3 x^0.5           9.27µs  10.17µs    99768.    7.86KB
#> 4 x^(1/2)         9.31µs  10.27µs    99079.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
