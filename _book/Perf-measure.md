...
#> 1 f()          99.5µs    131µs     7270.     792KB     111.
```
...
#> 1 sqrt(x)         1.02µs   1.52µs   534598.    7.86KB
#> 2 exp(log(x)/2)   6.03µs   6.89µs   145538.    7.86KB
#> 3 x^(1/2)         9.06µs  10.04µs    96727.    7.86KB
#> 4 x^0.5           9.22µs  10.37µs    95896.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
