...
#> 1 f()           102µs    165µs     5726.    4.65MB     81.3
```
...
#> 1 sqrt(x)         1.07µs   1.23µs   715075.    7.86KB
#> 2 exp(log(x)/2)   6.19µs   7.17µs   141066.    7.86KB
#> 3 x^0.5           9.31µs   9.55µs   100254.    7.86KB
#> 4 x^(1/2)         9.31µs    9.9µs    99310.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1     716.
#> 2       0 
