...
#> 1 f()          99.6µs    140µs     6814.     792KB     104.
```
...
#> 1 sqrt(x)         1.02µs   2.01µs   532134.    7.86KB
#> 2 exp(log(x)/2)   6.44µs   7.75µs    97181.    7.86KB
#> 3 x^0.5           9.31µs  10.31µs    96747.    7.86KB
#> 4 x^(1/2)         9.35µs  10.46µs    81671.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
