...
#> 1 f()           134µs    193µs     4893.     792KB     74.5
```
...
#> 1 sqrt(x)         1.35µs   2.75µs   313187.    7.86KB
#> 2 exp(log(x)/2)   8.08µs  11.48µs    80353.    7.86KB
#> 3 x^0.5          12.05µs   15.7µs    60322.    7.86KB
#> 4 x^(1/2)         12.1µs  15.95µs    60099.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
