...
#> 1 f()           102µs    143µs     6681.    4.65MB     94.9
```
...
#> 1 sqrt(x)         1.02µs   1.35µs   585710.    7.86KB
#> 2 exp(log(x)/2)   6.15µs    6.7µs   143967.    7.86KB
#> 3 x^0.5           9.22µs   9.72µs   100310.    7.86KB
#> 4 x^(1/2)         9.31µs  10.21µs    99384.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1     586.
#> 2       0 
