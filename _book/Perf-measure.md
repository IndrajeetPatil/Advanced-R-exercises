...
#> 1 f()          99.8µs    148µs     6485.    4.65MB     92.1
```
...
#> 1 sqrt(x)         1.02µs   1.31µs   580270.    7.86KB
#> 2 exp(log(x)/2)   6.15µs   7.03µs   142520.    7.86KB
#> 3 x^0.5           9.22µs  10.17µs   100093.    7.86KB
#> 4 x^(1/2)         9.27µs  10.25µs    99485.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1     581.
#> 2       0 
