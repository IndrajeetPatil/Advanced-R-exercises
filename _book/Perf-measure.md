...
#> 1 f()           101µs    166µs     5840.    4.65MB     82.9
```
...
#> 1 sqrt(x)         1.02µs   1.35µs   576604.    7.86KB
#> 2 exp(log(x)/2)   6.15µs   7.01µs   139464.    7.86KB
#> 3 x^0.5           9.27µs  10.17µs    99925.    7.86KB
#> 4 x^(1/2)         9.31µs  10.17µs    99619.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1     577.
#> 2       0 
