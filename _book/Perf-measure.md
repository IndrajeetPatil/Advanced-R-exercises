...
#> 1 f()           115µs    199µs     4867.     792KB     74.1
```
...
#> 1 sqrt(x)         1.27µs   2.46µs   346772.    7.86KB
#> 2 exp(log(x)/2)   7.38µs   10.6µs    91289.    7.86KB
#> 3 x^0.5          11.07µs  14.51µs    66217.    7.86KB
#> 4 x^(1/2)        11.15µs   14.6µs    65924.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
