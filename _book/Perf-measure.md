...
#> 1 f()           101µs    133µs     7309.    4.65MB     104.
```
...
#> 1 sqrt(x)         1.02µs   1.44µs   560559.    7.86KB
#> 2 exp(log(x)/2)   6.15µs   7.13µs   140459.    7.86KB
#> 3 x^0.5           9.27µs  10.21µs    97388.    7.86KB
#> 4 x^(1/2)         9.31µs  10.25µs    98174.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
