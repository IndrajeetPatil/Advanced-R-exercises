...
#> 1 f()          99.4µs    140µs     6856.    4.65MB     97.3
```
...
#> 1 sqrt(x)         1.02µs   1.44µs   564399.    7.86KB
#> 2 exp(log(x)/2)   6.15µs   7.13µs   142406.    7.86KB
#> 3 x^0.5           9.22µs  10.21µs    99472.    7.86KB
#> 4 x^(1/2)         9.31µs  10.25µs    99252.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
