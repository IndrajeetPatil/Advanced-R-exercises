...
#> 1 f()           101µs    136µs     7002.     792KB     107.
```
...
#> 1 sqrt(x)         1.02µs   1.97µs   553831.    7.86KB
#> 2 exp(log(x)/2)   6.15µs   7.13µs   143020.    7.86KB
#> 3 x^0.5           9.22µs   9.76µs   100177.    7.86KB
#> 4 x^(1/2)         9.31µs  10.19µs    99472.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
