...
#> 1 f()           101µs    150µs     6546.    4.65MB     93.0
```
...
#> 1 sqrt(x)         1.02µs   1.35µs   644914.    7.86KB
#> 2 exp(log(x)/2)   6.15µs   7.09µs   142139.    7.86KB
#> 3 x^0.5           9.22µs    9.7µs   100201.    7.86KB
#> 4 x^(1/2)         9.27µs  10.17µs    99779.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1     646.
#> 2       0 
