...
#> 1 f()          99.5µs    137µs     7133.    4.65MB     101.
```
...
#> 1 sqrt(x)         1.02µs   1.27µs   679487.    7.86KB
#> 2 exp(log(x)/2)   6.19µs   7.13µs   141137.    7.86KB
#> 3 x^0.5           9.27µs   9.47µs   100980.    7.86KB
#> 4 x^(1/2)         9.27µs   9.86µs    99381.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1     680.
#> 2       0 
