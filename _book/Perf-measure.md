...
#> 1 f()           107µs    160µs     6169.     792KB     93.9
```
...
#> 1 sqrt(x)         1.19µs   2.25µs   476715.    7.86KB
#> 2 exp(log(x)/2)   6.93µs   8.16µs   118812.    7.86KB
#> 3 x^0.5          10.33µs  11.32µs    85241.    7.86KB
#> 4 x^(1/2)        10.41µs   11.5µs    85427.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
