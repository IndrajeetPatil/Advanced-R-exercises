...
#> 1 f()           106µs    150µs     6242.    4.65MB     88.6
```
...
#> 1 sqrt(x)         1.02µs   1.35µs   603989.    7.86KB
#> 2 exp(log(x)/2)   6.15µs   6.79µs   141382.    7.86KB
#> 3 x^0.5           9.22µs   9.47µs   100615.    7.86KB
#> 4 x^(1/2)         9.31µs   9.59µs   100058.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1     605.
#> 2       0 
