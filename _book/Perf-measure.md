...
#> 1 f()          99.4µs    140µs     6759.     792KB     103.
```
...
#> 1 sqrt(x)          984ns   1.44µs   570859.    7.86KB
#> 2 exp(log(x)/2)   5.99µs   7.01µs   138854.    7.86KB
#> 3 x^0.5           8.98µs   9.63µs   101162.    7.86KB
#> 4 x^(1/2)          9.1µs  10.37µs    95299.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
