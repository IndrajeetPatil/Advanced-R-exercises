...
#> 1 f()           100µs    145µs     6495.    4.65MB     92.2
```
...
#> 1 sqrt(x)         1.02µs   1.44µs   579394.    7.86KB
#> 2 exp(log(x)/2)   6.15µs   7.07µs   142572.    7.86KB
#> 3 x^0.5           9.22µs  10.17µs   100018.    7.86KB
#> 4 x^(1/2)         9.31µs  10.21µs    99302.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
