...
#> 1 f()          99.5µs    133µs     7064.     792KB     108.
```
...
#> 1 sqrt(x)          984ns   1.84µs   569393.    7.86KB
#> 2 exp(log(x)/2)   6.15µs   7.26µs   137838.    7.86KB
#> 3 x^0.5           9.02µs     10µs    99786.    7.86KB
#> 4 x^(1/2)         9.22µs  10.25µs    97887.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
