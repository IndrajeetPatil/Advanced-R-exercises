...
#> 1 f()           146µs    198µs     4422.     792KB     67.3
```
...
#> 1 sqrt(x)         1.52µs   2.93µs   302928.    7.86KB
#> 2 exp(log(x)/2)   8.81µs  12.96µs    72900.    7.86KB
#> 3 x^0.5          13.12µs  17.06µs    56808.    7.86KB
#> 4 x^(1/2)        13.16µs   17.1µs    54600.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
