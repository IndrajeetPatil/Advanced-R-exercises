...
#> 1 f()           101µs    150µs     6052.    4.65MB     85.9
```
...
#> 1 sqrt(x)         1.07µs   1.35µs   599325.    7.86KB
#> 2 exp(log(x)/2)   6.19µs   6.89µs   139228.    7.86KB
#> 3 x^0.5           9.18µs    9.7µs   100165.    7.86KB
#> 4 x^(1/2)         9.27µs  10.25µs    98788.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1     600.
#> 2       0 
