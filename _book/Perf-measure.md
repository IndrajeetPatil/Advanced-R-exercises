...
#> 1 f()           102µs    154µs     6109.    4.65MB     86.7
```
...
#> 1 sqrt(x)         1.07µs   1.44µs   577236.    7.86KB
#> 2 exp(log(x)/2)    6.4µs   7.38µs   135277.    7.86KB
#> 3 x^0.5           9.59µs   9.76µs    99966.    7.86KB
#> 4 x^(1/2)         9.43µs   9.88µs    95186.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
