...
#> 1 f()           123µs    190µs     4719.     792KB     71.9
```
...
#> 1 sqrt(x)         1.35µs   1.84µs   423316.    7.86KB
#> 2 exp(log(x)/2)   8.04µs   9.31µs   106721.    7.86KB
#> 3 x^0.5          11.11µs  12.44µs    77431.    7.86KB
#> 4 x^(1/2)        12.05µs  13.24µs    76310.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
