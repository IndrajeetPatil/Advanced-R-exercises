...
#> 1 f()           100µs    138µs     6602.    4.65MB     93.7
```
...
#> 1 sqrt(x)         1.07µs   1.44µs   447072.    7.86KB
#> 2 exp(log(x)/2)   6.15µs    7.3µs   137433.    7.86KB
#> 3 x^0.5           9.27µs  10.21µs    98590.    7.86KB
#> 4 x^(1/2)         9.31µs  10.37µs    97684.    7.86KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
