...
#> 1 cumprod(v1)   82.02ns  82.02ns  5255904.        0B
#> 2 cumprodC(v1)   1.56µs   1.76µs   509080.    6.62KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
...
#> 1 cummin(v1)   82.02ns  123.1ns  3295702.        0B        0
#> 2 cumminC(v1)   1.93µs    2.3µs   427295.    6.62KB        0
```
...
#>   expression       min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>  <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 cummax(v1)  122.99ns 123.05ns  3291282.        0B        0
#> 2 cummaxC(v1)   1.84µs   2.17µs   383070.    6.62KB        0
```
...
#>   expression        min   median `itr/sec` mem_alloc
#>   <bch:expr>   <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 diff(v1, 2)    4.63µs   5.08µs   189674.        0B
#> 2 diffC(v1, 2)   2.21µs   2.83µs   347437.    2.49KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 range(v1)    2.01µs   2.17µs   441608.        0B        0
#> 2 rangeC(v1)   1.76µs   1.99µs   487702.    6.62KB        0
```
...
#>   expression        min   median `itr/sec` mem_alloc
#>   <bch:expr>   <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 var(v1)        7.22µs   7.83µs   125341.        0B
#> 2 variance(v1)   1.48µs   1.84µs   531255.    6.62KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
...
#>   expression              min   median `itr/sec` mem_alloc
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 median.default(v2)  21.36µs  25.58µs    38943.        0B
#> 2 medianC(v2)          1.52µs   1.84µs   534400.    2.49KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
...
#>   expression          min   median `itr/sec` mem_alloc
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 x1 %in% x2     738.01ns 943.02ns   970543.        0B
#> 2 matchC(x1, x2)   2.05µs   2.23µs   435148.    6.62KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
...
#>   expression        min   median `itr/sec` mem_alloc
#>   <bch:expr>   <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 unique(v1)     2.62µs   2.81µs   333973.        0B
#> 2 uniqueC2(v1)   2.21µs    2.4µs   389058.    6.62KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 min(v1)    246.04ns 287.02ns  3209019.        0B        0
#> 2 minC(v1)     1.68µs   2.05µs   477206.    6.62KB        0
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 max(v1)    163.97ns 205.01ns  3822616.        0B        0
#> 2 maxC(v1)     1.11µs   1.37µs   699250.    6.62KB        0
```
...
#>   expression          min   median `itr/sec` mem_alloc
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 which.min(v1)  368.98ns 450.99ns  2075673.        0B
#> 2 which_minC(v1)   1.72µs   1.84µs   520265.    6.62KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
...
#>   expression          min   median `itr/sec` mem_alloc
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 which.max(v1)  245.99ns 287.02ns  3318140.        0B
#> 2 which_maxC(v1)   1.15µs   1.31µs   668399.    6.62KB
#>   `gc/sec`
#>      <dbl>
#> 1        0
#> 2        0
