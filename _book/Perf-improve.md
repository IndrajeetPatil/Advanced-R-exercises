...
#> 1 lm            643µs    705µs     1373.    1.25MB
#> 2 speedglm      677µs    740µs     1348.   62.44MB
#> 3 biglm         549µs    607µs     1647.  936.43KB
#> 4 fastLm        616µs    685µs     1439.  982.55KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          533ns    697ns  1052230.    2.77KB
#> 2 fastmatch     492ns    615ns  1191170.    2.66KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         17.5ms   17.8ms      56.4    31.4MB
#> 2 fastmatch     492ns    574ns 1603906.         0B
```
...
#> 1 as.POSIXct   37.47µs  48.71µs    19538.        0B     0   
#> 2 as.POSIXlt   29.07µs  38.21µs    24046.        0B     0   
#> 3 ymd_hms       1.41ms   1.54ms      624.    23.6KB     5.67
#> 4 fastPOSIXct 615.01ns 697.01ns  1395309.        0B     0
```
...
#> 1 rowSums(x)                               109µs    164µs
#> 2 .rowSums(x, dim(x)[[1]], dim(x)[[2]])    107µs    159µs
#>   `itr/sec` mem_alloc
#>       <dbl> <bch:byt>
#> 1     5661.     859KB
#> 2     6216.     859KB
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          745µs    883µs     1045.    1.47MB
#> 2 custom        578µs    680µs     1472.    1.12MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          554µs    653µs     1457.     960KB
#> 2 custom        302µs    350µs     2881.     475KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          735µs    875µs     1111.    1.28MB
#> 2 custom        330µs    379µs     2641.     595KB
```
...
#>   expression                min   median `itr/sec` mem_alloc
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 crossprod(x, w)[[1]]    328ns    451ns  1872875.        0B
#> 2 sum(x * w)[[1]]         164ns    287ns  3203142.        0B
```
