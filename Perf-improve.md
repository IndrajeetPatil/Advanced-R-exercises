...
#> 1 lm           1.07ms   1.15ms      851.    1.27MB
#> 2 speedglm      1.4ms   1.49ms      667.    74.3MB
#> 3 biglm      977.69µs   1.01ms      984.   589.1KB
#> 4 fastLm       1.28ms   1.34ms      745.    4.49MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          1.3µs    1.4µs   643918.     2.8KB
#> 2 fastmatch     1.1µs    1.2µs   802040.    2.66KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         31.2ms   31.8ms      31.6    31.4MB
#> 2 fastmatch     1.1µs    1.2µs  778931.         0B
```
...
#> 1 as.POSIXct    36.8µs   40.2µs    24697.        0B     0   
#> 2 as.POSIXlt    26.1µs   27.7µs    35692.        0B     0   
#> 3 ymd_hms        2.9ms   3.02ms      330.    21.5KB     2.66
#> 4 fastPOSIXct    1.3µs    1.4µs   682037.        0B     0
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 rowSums       995µs    1.1ms      703.     859KB
#> 2 .rowSums      991µs   1.79ms      648.     859KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.18ms   1.21ms      800.    1.57MB
#> 2 custom      894.3µs  914.6µs     1088.    1.13MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          796µs    816µs     1221.     960KB
#> 2 custom        421µs    433µs     2281.     488KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.18ms   1.22ms      814.    1.28MB
#> 2 custom      510.2µs  528.7µs     1881.  594.45KB
```
...
#>   expression                min   median `itr/sec` mem_alloc
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 crossprod(x, w)[[1]]    999ns    1.1µs   820024.        0B
#> 2 sum(x * w)[[1]]         499ns    600ns  1548663.        0B
```
