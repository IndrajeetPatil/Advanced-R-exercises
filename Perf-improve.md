...
#> 1 lm          876.03µs 911.38µs     1071.    1.27MB
#> 2 speedglm      1.59ms   1.64ms      608.   75.03MB
#> 3 biglm        782.3µs 805.83µs     1178.   589.1KB
#> 4 fastLm      999.58µs   1.04ms      958.    4.48MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.17µs   1.23µs   745080.     2.8KB
#> 2 fastmatch       1µs   1.06µs   897390.    2.66KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         20.5ms   21.5ms      46.0    31.4MB
#> 2 fastmatch       1µs   1.05µs  903505.         0B
```
...
#> 1 as.POSIXct   29.45µs  31.19µs    31745.        0B     0   
#> 2 as.POSIXlt   20.13µs  21.13µs    46599.        0B    46.6 
#> 3 ymd_hms       2.24ms   2.33ms      428.    21.5KB     3.45
#> 4 fastPOSIXct   1.18µs   1.31µs   715095.        0B     0
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 rowSums       821µs 855.48µs     1003.     859KB
#> 2 .rowSums      821µs   1.28ms      793.     859KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          914µs    935µs     1044.    1.57MB
#> 2 custom        715µs    730µs     1360.    5.24MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          640µs    655µs     1513.     960KB
#> 2 custom        364µs    369µs     2687.     489KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          920µs    944µs     1049.    1.28MB
#> 2 custom        429µs    439µs     2247.  594.45KB
```
...
#>   expression                min   median `itr/sec` mem_alloc
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 crossprod(x, w)[[1]]    891ns    952ns  1002761.        0B
#> 2 sum(x * w)[[1]]         480ns    531ns  1732304.        0B
```
