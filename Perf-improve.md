...
#> 1 lm         864.56µs 900.77µs     1089.    1.26MB
#> 2 speedglm     1.55ms   1.59ms      626.   72.22MB
#> 3 biglm      777.86µs 810.96µs     1173.   589.1KB
#> 4 fastLm     964.68µs 991.15µs     1001.    4.48MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.16µs   1.21µs   758621.     2.8KB
#> 2 fastmatch    1.01µs   1.05µs   904390.    2.66KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         23.5ms  25.47ms      28.8    31.4MB
#> 2 fastmatch       1µs   1.05µs  912716.         0B
```
...
#> 1 as.POSIXct   29.66µs  31.32µs    31744.        0B     0   
#> 2 as.POSIXlt   19.47µs   20.7µs    43020.        0B    43.1 
#> 3 ymd_hms       2.23ms   2.31ms      431.    21.5KB     3.47
#> 4 fastPOSIXct   1.13µs   1.25µs   752374.        0B     0
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 rowSums       821µs   1.29ms      787.     859KB
#> 2 .rowSums      818µs   1.29ms      748.     859KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          877µs    898µs     1094.    1.57MB
#> 2 custom        677µs    692µs     1433.    5.24MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          609µs    622µs     1592.     960KB
#> 2 custom        343µs    349µs     2830.     489KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          890µs    912µs     1075.    1.28MB
#> 2 custom        406µs    413µs     2399.  594.45KB
```
...
#>   expression                min   median `itr/sec` mem_alloc
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 crossprod(x, w)[[1]]    871ns    912ns  1007494.        0B
#> 2 sum(x * w)[[1]]         460ns    491ns  1860363.        0B
```
