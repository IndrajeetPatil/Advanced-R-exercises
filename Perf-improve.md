...
#> 1 lm           1.25ms   1.31ms      752.    1.27MB
#> 2 speedglm     1.55ms   1.62ms      612.    74.3MB
#> 3 biglm        1.14ms   1.18ms      843.   589.1KB
#> 4 fastLm       1.46ms   1.51ms      662.    4.49MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          1.4µs    1.5µs   625444.     2.8KB
#> 2 fastmatch     1.1µs    1.2µs   772677.    2.66KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         40.7ms   41.5ms      23.9    31.4MB
#> 2 fastmatch     1.2µs    1.3µs  728655.         0B
```
...
#> 1 as.POSIXct    35.5µs   38.9µs    25436.        0B     0   
#> 2 as.POSIXlt      25µs   27.3µs    36210.        0B     0   
#> 3 ymd_hms       3.18ms    3.3ms      302.    21.5KB     2.44
#> 4 fastPOSIXct    1.4µs    1.4µs   671807.        0B     0
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 rowSums       696µs    778µs     1282.     859KB
#> 2 .rowSums      688µs    778µs     1284.     859KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.52ms   1.57ms      633.    1.57MB
#> 2 custom       1.19ms   1.23ms      813.    1.13MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.03ms   1.07ms      929.     960KB
#> 2 custom     497.31µs 518.01µs     1920.     488KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.52ms   1.56ms      638.    1.28MB
#> 2 custom     606.11µs 629.51µs     1570.  594.45KB
```
...
#>   expression                min   median `itr/sec` mem_alloc
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 crossprod(x, w)[[1]]   1000ns    1.1µs   815244.        0B
#> 2 sum(x * w)[[1]]         600ns    700ns  1302412.        0B
```
