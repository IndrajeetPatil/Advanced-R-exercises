...
#> 1 lm         877.09µs 913.61µs     1073.    1.26MB
#> 2 speedglm     1.56ms   1.61ms      620.   72.22MB
#> 3 biglm      790.81µs 822.38µs     1158.   589.1KB
#> 4 fastLm     983.91µs   1.01ms      982.    4.48MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         1.18µs   1.24µs   747031.     2.8KB
#> 2 fastmatch       1µs   1.06µs   896181.    2.66KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base         23.6ms  25.99ms      27.8    31.4MB
#> 2 fastmatch       1µs   1.05µs  907144.         0B
```
...
#> 1 as.POSIXct    29.6µs  31.37µs    31463.        0B     0   
#> 2 as.POSIXlt   20.18µs   21.3µs    46056.        0B    46.1 
#> 3 ymd_hms       2.25ms   2.36ms      423.    21.5KB     3.41
#> 4 fastPOSIXct   1.18µs    1.3µs   732700.        0B     0
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 rowSums       825µs   1.29ms      816.     859KB
#> 2 .rowSums      822µs   1.29ms      791.     859KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          900µs    923µs     1076.    1.57MB
#> 2 custom        697µs    714µs     1389.    5.24MB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          628µs    640µs     1545.     960KB
#> 2 custom        354µs    361µs     2738.     489KB
```
...
#>   expression      min   median `itr/sec` mem_alloc
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 base          902µs    928µs     1068.    1.28MB
#> 2 custom        419µs    428µs     2312.  594.45KB
```
...
#>   expression                min   median `itr/sec` mem_alloc
#>   <bch:expr>           <bch:tm> <bch:tm>     <dbl> <bch:byt>
#> 1 crossprod(x, w)[[1]]    882ns    941ns   988023.        0B
#> 2 sum(x * w)[[1]]         461ns    511ns  1779665.        0B
```
