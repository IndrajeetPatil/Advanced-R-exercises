...
```r
lobstr::ref(e$loop)
#> █ [1:0x555704c58498] <env> 
#> └─loop = [1:0x555704c58498]
```
...
#> [1] "0x555706dc1e28" "0x555706dc1e28"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x555706e133c8" "0x555706e133c8"
```
