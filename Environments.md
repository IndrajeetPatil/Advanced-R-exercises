...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55d5a65fd9d0] <env> 
#> └─loop = [1:0x55d5a65fd9d0]
```
...
#> [1] "0x55d5a7718c98" "0x55d5a7718c98"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55d5a74237b8" "0x55d5a74237b8"
```
