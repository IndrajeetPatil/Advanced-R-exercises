...
```r
lobstr::ref(e$loop)
#> █ [1:0x5637be838650] <env> 
#> └─loop = [1:0x5637be838650]
```
...
#> [1] "0x5637c0ed0cd8" "0x5637c0ed0cd8"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5637c0f22278" "0x5637c0f22278"
```
