...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55a18d6f0848] <env> 
#> └─loop = [1:0x55a18d6f0848]
```
...
#> [1] "0x55a18e3b57a0" "0x55a18e3b57a0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55a18e81de30" "0x55a18e81de30"
```
