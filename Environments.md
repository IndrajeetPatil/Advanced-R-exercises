...
```r
lobstr::ref(e$loop)
#> █ [1:0x55d147480920] <env> 
#> └─loop = [1:0x55d147480920]
```
...
#> [1] "0x55d1490f4220" "0x55d1490f4220"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55d149141980" "0x55d149141980"
```
