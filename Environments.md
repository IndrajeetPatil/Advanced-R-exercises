...
```r
lobstr::ref(e$loop)
#> █ [1:0x5626b5443da0] <env> 
#> └─loop = [1:0x5626b5443da0]
```
...
#> [1] "0x5626b6d55508" "0x5626b6d55508"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5626b6da4708" "0x5626b6da4708"
```
