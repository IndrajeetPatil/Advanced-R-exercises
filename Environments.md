...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55c7030d4cc8] <env> 
#> └─loop = [1:0x55c7030d4cc8]
```
...
#> [1] "0x55c705798c28" "0x55c705798c28"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55c7057e73c8" "0x55c7057e73c8"
```
