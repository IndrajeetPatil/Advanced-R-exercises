...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55c1ce779820] <env> 
#> └─loop = [1:0x55c1ce779820]
```
...
#> [1] "0x55c1cfd239f8" "0x55c1cfd239f8"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55c1cfffe0d8" "0x55c1cfffe0d8"
```
