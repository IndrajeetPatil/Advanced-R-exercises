...
```r
lobstr::ref(e$loop)
#> █ [1:0x5653ae017cf8] <env> 
#> └─loop = [1:0x5653ae017cf8]
```
...
#> [1] "0x5653afc23698" "0x5653afc23698"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5653afc74c28" "0x5653afc74c28"
```
