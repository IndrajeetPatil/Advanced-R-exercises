...
```r
lobstr::ref(e$loop)
#> █ [1:0x559993947498] <env> 
#> └─loop = [1:0x559993947498]
```
...
#> [1] "0x559995ab0b18" "0x559995ab0b18"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x559995b020b8" "0x559995b020b8"
```
