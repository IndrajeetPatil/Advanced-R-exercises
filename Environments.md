...
``` r
lobstr::ref(e$loop)
#> █ [1:0x560c4a398a68] <env> 
#> └─loop = [1:0x560c4a398a68]
```
...
#> [1] "0x560c4bcba930" "0x560c4bcba930"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x560c4b5c6820" "0x560c4b5c6820"
```
