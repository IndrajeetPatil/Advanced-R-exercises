...
```r
lobstr::ref(e$loop)
#> █ [1:0x5563db9c7500] <env> 
#> └─loop = [1:0x5563db9c7500]
```
...
#> [1] "0x5563dcd56b60" "0x5563dcd56b60"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5563dcdaa010" "0x5563dcdaa010"
```
