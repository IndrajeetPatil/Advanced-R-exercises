...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55f24bebd440] <env> 
#> └─loop = [1:0x55f24bebd440]
```
...
#> [1] "0x55f24cdba9a0" "0x55f24cdba9a0"
```

``` r
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55f24c76b7a0" "0x55f24c76b7a0"
```
