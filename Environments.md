...
``` r
lobstr::ref(e$loop)
#> █ [1:0x562e958e5888] <env> 
#> └─loop = [1:0x562e958e5888]
```
...
#> [1] "0x562e970bd7e0" "0x562e970bd7e0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x562e96c60098" "0x562e96c60098"
```
