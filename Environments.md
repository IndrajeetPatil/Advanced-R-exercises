...
```r
lobstr::ref(e$loop)
#> █ [1:0x563db3eb3038] <env> 
#> └─loop = [1:0x563db3eb3038]
```
...
#> [1] "0x563db57c22a0" "0x563db57c22a0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x563db58133b0" "0x563db58133b0"
```
