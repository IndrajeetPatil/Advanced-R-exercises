...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55932e0b5aa0] <env> 
#> └─loop = [1:0x55932e0b5aa0]
```
...
#> [1] "0x55932fabe078" "0x55932fabe078"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55932fa7e048" "0x55932fa7e048"
```
