...
``` r
lobstr::ref(e$loop)
#> █ [1:0x5617ba556910] <env> 
#> └─loop = [1:0x5617ba556910]
```
...
#> [1] "0x5617bb69be98" "0x5617bb69be98"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5617bb050840" "0x5617bb050840"
```
