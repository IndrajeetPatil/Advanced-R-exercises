...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55fea8d65910] <env> 
#> └─loop = [1:0x55fea8d65910]
```
...
#> [1] "0x55fea9eb0bf8" "0x55fea9eb0bf8"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55fea9863680" "0x55fea9863680"
```
