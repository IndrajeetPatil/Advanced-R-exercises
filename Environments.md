...
```r
lobstr::ref(e$loop)
#> █ [1:0x55e5259f4650] <env> 
#> └─loop = [1:0x55e5259f4650]
```
...
#> [1] "0x55e52808c6f8" "0x55e52808c6f8"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55e5280ddc98" "0x55e5280ddc98"
```
