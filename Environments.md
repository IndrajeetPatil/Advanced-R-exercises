...
```r
lobstr::ref(e$loop)
#> █ [1:0x55df622d8c60] <env> 
#> └─loop = [1:0x55df622d8c60]
```
...
#> [1] "0x55df63f4c588" "0x55df63f4c588"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55df63f99ce8" "0x55df63f99ce8"
```
