...
``` r
lobstr::ref(e$loop)
#> █ [1:0x563359951cc8] <env> 
#> └─loop = [1:0x563359951cc8]
```
...
#> [1] "0x56335c015c28" "0x56335c015c28"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x56335c0643c8" "0x56335c0643c8"
```
