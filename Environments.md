...
``` r
lobstr::ref(e$loop)
#> █ [1:0x5609ac2a3820] <env> 
#> └─loop = [1:0x5609ac2a3820]
```
...
#> [1] "0x5609ad610de0" "0x5609ad610de0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5609adc6ff30" "0x5609adc6ff30"
```
