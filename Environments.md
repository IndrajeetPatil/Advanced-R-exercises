...
```r
lobstr::ref(e$loop)
#> █ [1:0x55a245275c30] <env> 
#> └─loop = [1:0x55a245275c30]
```
...
#> [1] "0x55a2462e5ae0" "0x55a2462e5ae0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55a246355350" "0x55a246355350"
```
