...
```r
lobstr::ref(e$loop)
#> █ [1:0x5629ba16fea8] <env> 
#> └─loop = [1:0x5629ba16fea8]
```
...
#> [1] "0x5629bc0152d8" "0x5629bc0152d8"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5629bc0646a8" "0x5629bc0646a8"
```
...
#> [1] "package:stats"
#> attr(,"path")
#> [1] "/opt/R/4.3.1/lib/R/library/stats"
