...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55910d407df8] <env> 
#> └─loop = [1:0x55910d407df8]
```
...
#> [1] "0x55910e550828" "0x55910e550828"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55910df03bc0" "0x55910df03bc0"
```
