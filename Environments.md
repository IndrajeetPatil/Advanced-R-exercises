...
``` r
lobstr::ref(e$loop)
#> █ [1:0x5599aeffd810] <env> 
#> └─loop = [1:0x5599aeffd810]
```
...
#> [1] "0x5599b0370e18" "0x5599b0370e18"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x5599b09cbd68" "0x5599b09cbd68"
```
