...
``` r
lobstr::ref(e$loop)
#> █ [1:0x55f9079eb8a0] <env> 
#> └─loop = [1:0x55f9079eb8a0]
```
...
#> [1] "0x55f908b34df0" "0x55f908b34df0"
lobstr::obj_addrs(list(e2, e1$loop))
#> [1] "0x55f9084e3a48" "0x55f9084e3a48"
```
