...
- `trace`: A backtrace capturing the sequence of calls that lead to the current function 
...
#> List of 4
#>  $ message: chr "An error"
#>  $ trace  :Classes 'rlang_trace', 'rlib_trace', 'tbl' and 'data.frame':	8 obs. of  5 variables:
#>   ..$ call     :List of 8
